...
<head>
    ...
    <meta http-equiv="refresh" content="300"> <!-- Actualiza cada 5 minutos -->
    ...
    color: #495057;
        ...
        .grafico-ventas {
            margin-bottom: 30px;
                ...
                /* Estilos para el gráfico de productos */
        .grafico-productos {
            margin-bottom: 30px;
        }
        ...
        .selector-grafico button.active {
            background: #6a11cb;
            color: white;
            border-color: #4a00e0;
        }
                            ...
                            if ($resultUltimosPedidos->num_rows > 0) {
                                while ($pedido = $resultUltimosPedidos->fetch_assoc()) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <td>
                                            <button class=\"boton-accion ver\"><img src=\"imagenes/view-icon.png\" alt=\"Ver\"></button>
                                            <button class=\"boton-accion editar\"><img src=\"imagenes/edit-icon.png\" alt=\"Editar\"></button>
                                        </td>
                                    </tr>";
                                }
                            } else {
